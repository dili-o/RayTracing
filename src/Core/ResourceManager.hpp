...
namespace Helix {
    ...
    struct Resource {
        ...
        void                            remove_reference() { HASSERT(references != 0); --references; }
    ...
    struct ResourceLoader {
        ...
        virtual Resource*               create_from_file(cstring name, cstring filename, Helix::ResourceManager* resource_manager) { return nullptr; }
