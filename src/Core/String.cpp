...
#define HASSERT_OVERFLOW() HASSERT(false)
#else
#define HASSERT_OVERFLOW()
...
namespace Helix {
    ...
    void StringArray::shutdown() {
        ...
        hfree(string_to_index, allocator);
    ...
    cstring StringArray::intern(cstring string) {
        ...
        const sizet hashed_string = Helix::hash_bytes((void*)string, length, seed);
